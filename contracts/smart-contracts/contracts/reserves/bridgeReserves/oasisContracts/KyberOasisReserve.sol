...
contract OtcInterface {
    ...
    function getBestOffer(ERC20 sellGem, ERC20 buyGem) public returns(uint);
    function getWorseOffer(uint id) public returns(uint);
...
contract KyberOasisReserve is KyberReserveInterface, Withdrawable, Utils2 {
    ...
    uint internal COMMON_DECIMALS = 18;
