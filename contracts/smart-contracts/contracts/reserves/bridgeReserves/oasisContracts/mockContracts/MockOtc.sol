...
contract MockOtc {
    ...
    uint internal OFFER_WEI_VALUE = 3 * (10**18);
    uint internal MAKER_PAYS_DAI_OFFER_ID = 1;
    uint internal MAKER_BUYS_DAI_OFFER_ID = 2;
    uint internal MAKER_PAYS_MKR_FIRST_OFFER_ID = 3;
    uint internal MAKER_PAYS_MKR_SECOND_OFFER_ID = 4;
    uint internal MAKER_PAYS_MKR_THIRD_OFFER_ID = 5;
    uint internal MAKER_BUYS_MKR_FIRST_OFFER_ID = 6;
    uint internal MAKER_BUYS_MKR_SECOND_OFFER_ID = 7;
    uint internal MAKER_BUYS_MKR_THIRD_OFFER_ID = 8;
    ...
    function getOffer(uint id) public returns (uint, ERC20, uint, ERC20) {
        var offer = offers[id];
        return (offer.payAmt, offer.payGem, offer.buyAmt, offer.buyGem);
    }

    function getBestOffer(ERC20 offerSellGem, ERC20 offerBuyGem) public returns(uint) {
